...
of its operand, starting with the ones digit (a 5 in this case),
...
Of course dgts could have delivered the digits in the
...
to describe the sequence, but the sequence itself is a mathematical object.
...
Besides delivering the digits in reverse order, leading zeros are omitted.
...
However, dgts doesn't include any leading zeros in the numerals it delivers.
...
in the ``arithmetic-3/floor-mod/floor-mod'' book.
...
The rationale for strong induction is similar to
...
to prove theorem \{\emph{Horner 2}\}:
\begin{quote}
