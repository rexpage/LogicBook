...
decimal numerals is that it has powers of two, whereas the decimal formula had
...
\index{representation!binary numeral}\index{operator, by name!numb (number from bits)}\seeonlyindex{numb}{operator}\index{equation, by name!\{numb0\}, \{2numb\}, \{2numb+1\}}
\end{figure}
