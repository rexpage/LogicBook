...
\exer {Define in ACL2 a theorem about the operator \textsf{add-bin} (Excercise \ref{ex:add-bin})
...
Modular arithmetic makes twos-complement 
...
%\end{center}
\caption{Two's-Complement Numerals for 3-bit Words}
