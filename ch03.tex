...
ACL2 uses a \index{prefix notation}\index{operator!prefix notation}prefix notation
to denote operations,
rather than the \index{infix notation}\index{operator!infix notation}infix notation
that you are accustomed to.
In ACL2's prefix notation, a computational \index{formula!prefix notation}formula starts with a parenthesis,
...
\seeonlyindex{include-book}{directive}\index{directive!include-book}include-book directive.
...
Proof Pad facilitates that kind of \index{testing!doublecheck}testing with a package called
\index{doublecheck}\index{book!doublecheck}\index{teachpacks!doublecheck}
doublecheck
that generates \index{random data!generating}\index{random data!testing with}\index{testing!with random data}random data
...
\index{doublecheck}\index{testing!doublecheck}
\index{book!doublecheck}\index{teachpacks!doublecheck}
\index{teachpacks!:dir}\index{directory (:dir)!:teachpacks}
\index{book!directory (:dir)}
\index{testing!teachpack}\index{book!testing}
...
\index{testing!with random data}\index{random data!testing with}
\index{defproperty}defproperty and a name for the property to be tested,
...
the \index{operator, by name!append}\index{append!operator}operator ``append''
...
Using the ``len'' \index{operator, by name!len (length of list)}\seeonlyindex{len}{operator}operator,
...
\begin{aside}
A \index{natural number}``natural number'' is a whole number (that is, an integer)
...
\index{operator, by name!mod (remainder)}
\label{mod-function}
...
\seeonlyindex{third-grade long division}{division}
long division: third-grade stuff.
...
\begin{aside}
\index{arithmetic!modular}\index{modular arithmetic}\index{division!floor, mod}
\index{operator, by name!mod (remainder)}Modular arithmetic
(sometimes called \index{clock arithmetic}clock arithmetic)
...
Generating \index{random data!generating}\index{testing!with random data}random data is an art.
...
\index{let* names for values}\index{formula!let*}\index{variable!let*}``let*'' formula,
which provides a way to attach names to \index{value, let* name for}values temporarily
...
\index{formula!let*}\index{variable!let*}\index{let* names for values}\index{value, let* name for}
\label{let*-def}
\end{aside}
...
\index{operator!numeric order ($<$, $<=$, $=$, $>=$, $>$)}
\index{number!order ($<$, $<=$, $=$, $>=$, $>$)}
\seeonlyindex{less than ($<$)}{predicate}
\begin{Verbatim}
...
\index{operator, by name!ceiling (divide, round up)}\seeonlyindex{ceiling}{operator}
\index{ceiling brackets}
\index{brackets!ceiling}
\index{operator, by name!floor (divide, round down)}\seeonlyindex{floor}{operator}\index{division!floor, mod}
\index{floor brackets}
\index{brackets!floor}
\begin{center}
\begin{tabular}{lll}
...
\Exercise The ``max'' \index{operator, by name!max (of two operands)}\seeonlyindex{max}{operator}operator chooses the larger of two numbers:
...
\index{operator!numeric order ($<$, $<=$, $=$, $>=$, $>$)}
\index{number!order ($<$, $<=$, $=$, $>=$, $>$)}
\seeonlyindex{greater or equal ($>=$)}{predicate}
greater than or equal to (>=) both $x$ and $y$.
...
\Exercise
The ACL2 \index{operator, by name!reverse (elements in list)}\seeonlyindex{reverse}{operator}operator ``reverse''
