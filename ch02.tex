...
For example, the predicate $R$, defined as follows, has two indexes.
\begin{center}
$R(m, n) \equiv ((n + 7) = m)$
\end{center}
...
A Boolean variable $x$ stands for a proposition,
such as ``Socrates is a man.''
...
In other words we intend the proposition $x$ to mean something the real world,
...
but using it can be cumbersome to the point of infeasibilty.
