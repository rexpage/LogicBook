...
\index{panic, don't}\index{disheartened?}\index{frustration}
\index{baffled?}\index{worried?}\index{scared?}\index{funk, in a}
...
\index{reasoning!with equations}\index{substitution}\index{formula!substitution}
...
you may expect that there are reptiles in the park,
but if reptiles are reported, you cannot assume that
they are turtles. They might be rattlesnakes.
In the notation of logic, 
\emph{turtle} $\rightarrow$ \emph{reptile} is true,
but \emph{reptile}} $\rightarrow$ \emph{turtle} isn't.}
In symbolic logic,
...
\index{equation, by name!\{$\wedge$ implication\}}
\index{equation, by name!\{absurd 1\}, \{absurd 2\}}
...
There are logic \index{digital gate}
\index{Boolean!gate}\index{gate!logic}\index{logic!gate}gates
...
However, their negations, \index{nor!logic gate}\emph{nor} and \index{nand!logic gate}\emph{nand}, are.
...
\index{logic!gate}\index{gate!logic}\index{universal gate}\index{gate!universal}
...
So, take heart. Keep trying.\index{panic, don't}
...
A \index{theorem}theorem asserts that there is a derivation of the conclusion
...
Each rule
\index{citation!inference rule}\index{inference rule!citation}citation has three parts:
\begin{quote}
\begin{enumerate}
...
\seeonlyindex{above the line}{proof}\seeonlyindex{below the line}{proof}
\index{line (natural deduction)!above/below}line.
For example, the \{$\neg$ introduction\} rule is one that
constrains formulas both above and below the line.

When a rule is
\index{citation!inference rule}\index{inference rule!citation}
\seeonlyindex{rule of inference}{inference rule}
...
\index{natural deduction!tree diagram}\index{proof!tree diagram}
...
Of course, since \index{proof!dashed line}
\index{line (natural deduction)!dashed}dashed lines indicate separate proofs,
...
\index{hypothesis!discharge}\index{discharge hypothesis}\index{Assume (natural deduction)!discharge}
\index{inference rule!discharge hypothesis}
\index{proof!discharge hypothesis}\index{Assume (natural deduction)!discharge}discharging
...
\index{hypothesis!discharge}\index{discharge hypothesis}\index{Assume (natural deduction)!discharge}
\index{inference rule!discharge hypothesis}
\index{proof!discharge hypothesis}discharged
assumption
...
cites the
\index{proof!reductio ad absurdum}
\index{inference rule, by name!\{reductio ad absurdum\}} \index{reductio ad absurdum}reductio ad absurdum rule
...
\Exercise
Use natural deduction to prove
\index{theorem, by name!\{nor commutes\}}
\index{nor!commutes}\index{commutative}
...
\Exercise
Use natural deduction to prove
\index{theorem, by name!\{nand commutes\}}
\index{nand!commutes}\index{commutative}
...
\Exercise
Use natural deduction to prove
\index{theorem, by name!\{nor elimination 1\}}
\index{nor!elimination}
Theorem \{nor elimination 1\}: $\neg (a \vee b)$ $\vdash$ $\neg a$

\Exercise
Use natural deduction to prove
\index{DeMorgan}\index{theorem!DeMorgan}
\index{theorem, by name!\{DeMorgan $\vee$ forward\}}
...
Use natural deduction to prove
\index{DeMorgan}\index{theorem!DeMorgan}
\index{theorem, by name!\{DeMorgan $\vee$ backward\}}
...
the \index{proposition}\index{proposition!vs predicate}
\index{predicate!vs proposition}proposition
...
\index{there exists ($\exists$)}\index{existential quantifier ($\exists$)}quantification
...
called a
\index{bound variable}\index{variable!free}\index{variable!bound}\index{free variable}
...
\index{quantifier!$\exists$}\index{quantifier!existential}\index{existential quantifier ($\exists$)}
...
\begin{center}
\index{equation!defining ($\equiv$)}\index{definition!equation ($\equiv$)}
\index{equivalence!by definition ($\equiv$)}\index{three-line equal ($\equiv$)}
\begin{tabular}{ll}
...
\Exercise
Mark the
\index{free variable}\index{bound variable}\index{variable!free}\index{variable!bound}
