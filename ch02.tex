...
\index{Boolean!formula}\index{syntax, of formulas}
...
\end{tabular}
\end{center}
\index{Boolean!algebra}\index{formula!grammar}\index{grammar, of formulas}\index{syntax, of formulas}
...
\index{equation!grammar}\index{formula!grammar}\index{grammar, of formulas}\index{syntax, of formulas}
\begin{tabular}{cc}
\hline
\emph{symbol from \{bin-op\} rule}      & \emph{matching element in}  $(x \vee (\neg y))$ \\
\hline
