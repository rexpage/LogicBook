...
That explains the note prohibiting the occurrence of $x$ as
...
rules $\{\neg\forall\}$ and $\{\neg\exists\}$
are the quantifier analogs of the DeMorgan equations, \{$\vee$ DeMorgan\} and \{$\wedge$ DeMorgan\}
...
A ``for most'' quantifier (${\sim}{\forall}$) might be perfectly sensible.
