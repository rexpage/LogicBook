...
\begin{enumerate}
\item The key at each node follows every key
      that occurs in its left subtree.
\item The key at each node precedes every key
...
\Exercise Observe, experimentally, using operators defined
in Aside~\ref{aside:AVL-heights} (page \pageref{aside:AVL-heights}),
