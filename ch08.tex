...
\index{axiom, by name!\{mux0x\}, \{mux0y\}, \{mux1y\}, \{mux11\}}
...
\index{operator!Boolean equivalence ($\leftrightarrow$)}
\index{equivalence!Boolean ($\leftrightarrow$)}operator
...
\seeonlyindex{occurs-in list}{predicate}
\begin{quote}
\label{def:occurs-in}
