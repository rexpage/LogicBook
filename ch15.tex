...
draws a \index{jagged line}jagged \index{line!jagged}line 
...
In the inductive equation \{jg1\} in the definition of the operator $jagged$,
...
and it is also used to \index{jostle}jostle the line drawn by the operator $line$.
