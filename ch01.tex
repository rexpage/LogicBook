...
\begin{aside}
Logicians and mathematicians have been studying models of \index{computation model}\index{model of computation}computation
...
was the first to describe \index{uncomputable}\index{incomputable}uncomputable problems,
...
with \index{inductive definition}\index{definition, inductive}inductive definitions are sometimes
called \index{recursive}``recursive'' functions. We try to avoid that term because it is
...
\index{inductive definition}Inductive \index{definition, inductive}definitions
...
\index{equation!\{h1\}}\index{equation!\{h0\}}
...
The equation \{h1\} is \index{circular definition}circular because both sides of the equation
