...
The proof engine \index{ACL2r}ACL2r, which is an extension of ACL2, the mechanized logic 
that is used extensively in this book, employs Robinson's 
\index{non-standard analysis}non-standard analysis
